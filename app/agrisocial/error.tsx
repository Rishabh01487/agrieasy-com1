    ...
    <div style={{ minHeight: '100vh', background: '#fafbfc', fontFamily: "var(--font-poppins), 'Poppins', 'Segoe UI', sans-serif", display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ textAlign: 'center', maxWidth: 420 }}>
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/agrisocial/explore" style={{ padding: '10px 22px', background: '#FFFFFF', color: '#42476E', border: '1.5px solid #7BA7D9', borderRadius: 10, fontWeight: 700, textDecoration: 'none', fontSize: '0.88rem' }}>Explore Posts</Link>
          <Link href="/" style={{ padding: '10px 22px', background: '#FFFFFF', color: '#42476E', border: '1.5px solid #7BA7D9', borderRadius: 10, fontWeight: 700, textDecoration: 'none', fontSize: '0.88rem' }}>Go Home</Link>
        </div>
      </div>
    </div>
  )
