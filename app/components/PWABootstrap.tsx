    ...
    <>
      ...
      {showInstall && (
        <div style={{
          ...
          border: '1.5px solid #2563eb', zIndex: 9999, display: 'flex', alignItems: 'center', gap: 12,
          fontFamily: "'Inter',sans-serif",
        }}>
          <div style={{ width: 44, height: 44, borderRadius: 10, background: 'linear-gradient(135deg, #2563eb 0%, #3b82f6 50%, #60a5fa 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.4rem', flexShrink: 0 }}>🌾</div>
          ...
          <button onClick={handleInstall} style={{ padding: '8px 16px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: 8, fontSize: '0.84rem', fontWeight: 700, cursor: 'pointer', flexShrink: 0, whiteSpace: 'nowrap' }}>Install</button>
      ...
      {showIOSHint && (
        <div style={{
          position: 'fixed', bottom: 16, left: 16, right: 16, maxWidth: 480, margin: '0 auto',
          background: '#fff', borderRadius: 16, padding: 16, boxShadow: '0 10px 30px rgba(0,0,0,0.2)',
          border: '1.5px solid #2563eb', zIndex: 9999, fontFamily: "'Inter',sans-serif",
        }}>
