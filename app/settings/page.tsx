  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: "var(--font-poppins), 'Poppins', 'Segoe UI', system-ui, sans-serif", color: '#0f172a' }}>
      ...
      <nav style={{
        ...
        <Link href={dashboardHref} style={{ color: '#31372B', textDecoration: 'none', fontWeight: 700, fontSize: '0.88rem' }}>← {t('common.back')}</Link>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <button
              ...
              style={{
                ...
                border: `2px solid ${lang === 'en' ? '#31372B' : '#e2e8f0'}`,
            ...
            >
              ...
              <div style={{ textAlign: 'left' }}>
                <p style={{ margin: 0, fontSize: '1rem', fontWeight: 800, color: lang === 'en' ? '#31372B' : '#0f172a' }}>English</p>
                <p style={{ margin: '2px 0 0', fontSize: '0.74rem', color: '#64748b' }}>Default</p>
              </div>
              {lang === 'en' && <span style={{ marginLeft: 'auto', color: '#31372B', fontSize: '1.2rem' }}>✓</span>}
            </button>
            ...
            <button
              ...
              style={{
                flex: 1, padding: '16px 20px', borderRadius: 14,
                border: `2px solid ${lang === 'hi' ? '#31372B' : '#e2e8f0'}`,
            ...
            >
              <span style={{ fontSize: '1.8rem' }}>🇮🇳</span>
              <div style={{ textAlign: 'left' }}>
                <p style={{ margin: 0, fontSize: '1rem', fontWeight: 800, color: lang === 'hi' ? '#31372B' : '#0f172a' }}>हिंदी</p>
                <p style={{ margin: '2px 0 0', fontSize: '0.74rem', color: '#64748b' }}>Hindi</p>
              </div>
              {lang === 'hi' && <span style={{ marginLeft: 'auto', color: '#31372B', fontSize: '1.2rem' }}>✓</span>}
            </button>
          </div>
        </div>
