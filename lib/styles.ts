...
export const SOCIAL = {
  ...
  primary: '#B8423F',
  primaryHover: '#9A3835',
  primaryLight: 'rgba(184,66,63,0.15)',
  primarySoft: 'rgba(184,66,63,0.08)',
  accent: '#B8423F',
  text: '#4A2020',
  textSecondary: '#6A4040',
  muted: '#8A6060',
  border: 'rgba(184,66,63,0.3)',
  borderLight: 'rgba(184,66,63,0.15)',
  card: SHARED.white,
  green: '#B8423F',
  greenLight: 'rgba(184,66,63,0.1)',
  red: '#B8423F',
  redLight: '#fef2f2',
  gradient: 'linear-gradient(135deg, #B8423F 0%, #9A3835 100%)',
  gradientSoft: 'linear-gradient(135deg, rgba(184,66,63,0.12), rgba(184,66,63,0.06))',
  gradientRing:
    'linear-gradient(45deg, #B8423F 0%, #9A3835 25%, #D9534F 50%, #9A3835 75%, #B8423F 100%)',
  clips: {
    bg: '#4A2020',
    card: '#111827',
    text: '#f8fafc',
    muted: '#94a3b8',
    accent: '#B8423F',
    gradient: 'linear-gradient(135deg, #B8423F 0%, #9A3835 50%, #D9534F 100%)',
  },
}
