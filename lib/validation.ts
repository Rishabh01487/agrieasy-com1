...
export const registerSchema = z.object({
  ...
  // add it later from the dashboard). The empty string '' is accepted here
  // so Google registration goes through cleanly. The register API route
  // enforces the "address required" rule for MANUAL users separately.
  address: z.union([
    z.literal(''),
